...
| Начинающий жонглер | ![Medium](https://img.shields.io/badge/Medium-f39c12?style=for-the-badge) | Magic hash в PHP: обход проверки `md5($code) == "0e..."` через строку с MD5 вида `0e<digits>` | [Открыть](./Aspiringjuggler/) |
| Редактор тем | ![Medium](https://img.shields.io/badge/Medium-f39c12?style=for-the-badge) | XSS через `#theme=`: обход валидации в `window.onload`, инъекция через `innerHTML` и кража cookie админа через webhook | [Открыть](./Themeeditor/) |
